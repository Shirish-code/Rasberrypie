...
default_args = {
 ...
 'solutionname': 'myfirsttssproject2-82a3',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_myfirsttssproject2-82a3", default_args=default_args, tags=["tml_system_step_1_getparams_dag_myfirsttssproject2-82a3"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
