...
default_args = {
  ...
  'mqtt_broker' : '1ee5e74c0e1b44aba5fb1f75ba1c347d.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_testproject-82a3", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_testproject-82a3"], schedule=None,catchup=False)
